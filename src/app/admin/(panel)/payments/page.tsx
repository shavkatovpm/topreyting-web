...
import { Notice, PageHeader, StatusBadge, Table, fmtDate, td, textareaCls, th } from "../../_components/ui";
              ...
              <td className={td}>
                ...
                {isSuper && p.status === "CONFIRMED" && (
                  <details className="mt-1">
                    <summary className="cursor-pointer text-xs text-red-700">Bekor qilish</summary>
                    <AdminForm
                      action={voidPayment.bind(null, p.id)}
                      submitLabel="Bekor qilish"
                      confirmText="To'lovni bekor qilasizmi? Reyting qayta hisoblanadi."
                      className="mt-2 w-56"
                      buttonClassName="mt-2 h-8 rounded-md bg-red-600 px-3 text-xs font-medium text-white disabled:opacity-50"
                    >
